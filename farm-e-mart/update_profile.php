...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `user_form` SET name = '$update_name', email = '$update_email', address = '$update_address' WHERE id = '$user_id'") or die('query failed');
...
<div class="update-profile" id="container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="javascript:history.back(-1);" class="delete-btn">go back</a>
   </form>
