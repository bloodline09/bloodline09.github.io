...
<body>
    <div style="clear: both"></div>
        ...
        <div class="table-responsive">
            ...
            <a href="cardpayment.php?action=empty&id=<?php echo $value["product_id"]; ?>" class="checkout bp" onclick="return confirm('thank you for shopping with us!')">Place Order</a>
